...
//    public void UnlockNextPlantBed()
//    {
//        // Find the next plant bed whose barrier needs to be activated
//        Debug.Log("Unlocking plantbed");
//        for (int i = 0; i < barriers.Length; i++)
//        {
//            if (barriers[i].activeSelf)
//            {
//                barriers[i].SetActive(false); // Deactivate the barrier (unlock the bed)
//                Debug.Log("Plant bed unlocked: " + plantBeds[i].name);
//                break; // Exit after unlocking one barrier
//            }
//        }
//    }
//}
